...
export class ResetPasswordComponent {
  ...
  passwordChanges = this.resetPassword.controls.password.valueChanges.subscribe(value => {
    this.password = this.resetPassword.get('password_confirmation')?.setValidators(confirmPasswordValidator(value!))
    this.password = this.resetPassword.get('password_confirmation')?.updateValueAndValidity()
  })
  onSubmit() {
    this.isLoading = true
