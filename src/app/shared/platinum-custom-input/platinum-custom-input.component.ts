...
@Component({
  selector: 'app-platinum-custom-input',
  templateUrl: './platinum-custom-input.component.html',
  styleUrls: ['./platinum-custom-input.component.css']
})
export class PlatinumCustomInputComponent {
